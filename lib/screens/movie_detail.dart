...
import 'package:movie_db_app/models/movie_cast.dart';
import 'package:movie_db_app/models/movie_list.dart';
import 'package:movie_db_app/utils/helpers.dart';
import 'package:movie_db_app/configs/configs.dart';
import 'package:movie_db_app/constants/colors.dart';
...
import 'package:movie_db_app/blocs/moviecast/movie_cast_cubit.dart';
import 'package:movie_db_app/blocs/moviedetail/movie_detail_cubit.dart';
import 'package:movie_db_app/blocs/similiarmovie/similiar_movie_cubit.dart';
...
class _DetailMovieState extends State<DetailMovie> {
  ...
  void initState() {
    ...
    context.read<MovieCastCubit>().getMovieCast(widget.movieId);
    context.read<SimiliarMovieCubit>().getSimiliarMovies(widget.movieId);
    super.initState();
  }
